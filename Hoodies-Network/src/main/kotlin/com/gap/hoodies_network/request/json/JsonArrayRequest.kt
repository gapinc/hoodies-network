...
/**
 * JsonArrayRequest class parses response to jsonArray
 */
class JsonArrayRequest @JvmOverloads constructor(
    url: String?, method: String?, jsonRequest: JSONArray?,
    ...
    override fun parseNetworkResponse(response: Response<Any>?): Response<Any>? {
        ...
        return networkHelper.getParseNetworkResponse(response, true)
    }
}
